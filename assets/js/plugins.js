...
window.addEventListener("scroll", (event) => {
  ...
  const header2 = document.getElementById("stickyHeader-mobileNav");
  if (header2) {
    if (header2.classList.value.includes("border-b") && window.scrollY > 0) {
      // document.querySelector(".change-position").style.remove("top");
      console.log(document.querySelector(".change-position").classList);
      document.querySelector(".change-position").classList.add("sm:top-[67px]");
      document
        .querySelector(".change-position")
        .classList.remove("sm:top-[123px]");
      header2.classList.remove("border-b");
    } else if (
      !header2.classList.value.includes("border-b") &&
      window.scrollY === 0
    ) {
      header2.classList.add("border-b");
      console.log(document.querySelector(".change-position").classList);
      document
        .querySelector(".change-position")
        .classList.add("sm:top-[123px]");
      document
        .querySelector(".change-position")
        .classList.remove("sm:top-[67px]");
    }
  }
});
